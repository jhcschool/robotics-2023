...
public class RobotConstraints {
    ...
    public static final double CLAW_LENGTH_FROM_CENTER = 11.4;
    public static final double OUTPUT_LENGTH_FROM_CENTER = 16.75;
    public static final double LEFT_CLAW_WIDTH_FROM_CENTER = 2.5;
